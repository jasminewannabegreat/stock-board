...
export default function () {
	var accelerationFactor = defaultOptions.accelerationFactor,
	    maxAccelerationFactor = defaultOptions.maxAccelerationFactor;
	...
	function calculator(data) {
		...
		var algorithm = mappedSlidingWindow().windowSize(2).undefinedValue(function (_ref) {
			...
			var use = isDefined(prev.use) ? prev.use === "rising" ? risingSar > now.low ? "falling" : "rising" : fallingSar < now.high ? "rising" : "falling" : risingSar > now.low ? "falling" : "rising";
