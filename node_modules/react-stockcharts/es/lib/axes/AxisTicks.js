...
AxisTicks.helper = function (props, scale) {
	...
	var ticks = isNotDefined(tickValues) ? scale.ticks ? scale.ticks.apply(scale, tickArguments) : scale.domain() : tickValues;

	var baseFormat = scale.tickFormat ? scale.tickFormat.apply(scale, tickArguments) : identity;
